print("Loading Private Version 1.01")

game:GetService("StarterGui"):SetCore("SendNotification",{
Title = "HttpGet not needed GUI!",
Text = "Loading Private Version 1.01", 
...
local Window = Rayfield:CreateWindow({
   Name = "Simple arsenal for when httpget dosent work",
   LoadingTitle = "sponsored by dexian",
LoadingSubtitle = "credits to lewis for skidding!",
   ConfigurationSaving = {
      Enabled = true,
...
local Button = Tab:CreateButton({
   Name = "Aimbot (click once or glitch)",
   Callback = function()
...
print ("loading 8/10")
local Button = Tab:CreateButton({
   Name = "Universal movement!",
   Callback = function()
  print ("dosent really do anything")
   end,
})
end
wait (2.5)
print ("loading 9/10")
print ("finished loading at 10/10")
